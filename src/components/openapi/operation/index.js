...
export const shortDescriptions = {
  ...
  CreateProcess: "Creates a process that is modeled as BPMN XML.",
  ...
  SendMessage: "Sends a message to notify a message subscriber or to buffer the message.",
  ...
  UpdateUserTask: "Updates a user task's state, variables and/or tags. To avoid concurrent updates, the user task's current revision must be specified.",
}
